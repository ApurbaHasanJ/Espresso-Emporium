...
const Home = () => {
  ...
  return (
    <div>
      {/* home banner */}
      <div
        className="relative w-full h-screen bg-no-repeat bg-cover bg-center sm:bg-top"
        style={{
          backgroundImage: "url(https://i.postimg.cc/tJ7qrkP3/3.png)",
        }}
      >
      ...
      <div
        ...
        className="text-center mt-28 text-[#1B1A1A]  bg-no-repeat bg-contain bg-center sm:bg-top"
      >
        {/* Section header */}
        <div className="">
      ...
      <div className="my-container text-center mt-24">
        ...
        <div className="grid lg:grid-cols-4 gap-5 md:grid-cols-2 mt-11">
          <img
            ...
            src="https://i.postimg.cc/65GnHfBL/Rectangle-9.png"
            alt=""
          />
          <img
            className="rounded-md "
            src="https://i.postimg.cc/XYfFWNGr/Rectangle-10.png"
            alt=""
          />
          <img
            className="rounded-md "
            src="https://i.postimg.cc/8CTvz8Mt/Rectangle-11.png"
            alt=""
          />
          <img
            className="rounded-md "
            src="https://i.postimg.cc/cHH8fQD3/Rectangle-12.png"
            alt=""
          />
          <img
            className="rounded-md "
            src="https://i.postimg.cc/k4pRsBZp/Rectangle-13.png"
            alt=""
          />
          <img
            className="rounded-md "
            src="https://i.postimg.cc/gjLXTGbk/Rectangle-14.png"
            alt=""
          />
          <img
            className="rounded-md "
            src="https://i.postimg.cc/7Z87jJ6v/Rectangle-15.png"
            alt=""
          />
          <img
            className="rounded-md "
            src="https://i.postimg.cc/zfpgLdk5/Rectangle-16.png"
            alt=""
          />
        </div>
      </div>
